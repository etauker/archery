var transactions = [
	{
		...
		"dateTime" : "2019-01-23 21:25:57",
		"reading" : 8.8,
		"carbohydrates" : 120,
		"insulinUnitsShort" : 13,
		"insulinUnitsLong" : 16,
		"meal" : "Before Bed",
	...
	},
	{
		...
		"dateTime" : "2019-01-21 22:36:49",
		"reading" : 6.2,
		"carbohydrates" : 120,
		"insulinUnitsShort" : 12,
		"insulinUnitsLong" : 16,
		"meal" : "Before Bed",
	...
	},
	{
		...
		"dateTime" : "2019-01-21 17:43:48",
		"reading" : 16.4,
		"carbohydrates" : 90,
		"insulinUnitsShort" : 11,
		"insulinUnitsLong" : null,
		"meal" : "Dinner",
		"note" : "Before basketball.",
		"correction_units" : 2,
	...
	},
	{
		...
		"dateTime" : "2019-01-20 20:34:01",
		"reading" : 10.9,
		"carbohydrates" : 210,
		"insulinUnitsShort" : 18,
		"insulinUnitsLong" : null,
		"meal" : "Dinner",
...
transactions = transactions
  .map(transaction => {
      if (transaction.dateTime) {
          ...
          if (transaction.insulinUnitsShort) {
              let carbs = transaction.carbohydrates || 0;
              let units = transaction.insulinUnitsShort || 0;
              ...
              if (transaction.insulinUnitsShort < minInsulinUnitsShort) {
                  minInsulinUnitsShort = units;
              }
              if (transaction.insulinUnitsShort > maxInsulinUnitsShort) {
...
function getPointColour(transaction) {
    ...
    let matchingPeriod = periods.find(period => {
        ...
        let startDateTime = new Date(transaction.dateTime);
        ...
        let endDateTime = new Date(transaction.dateTime);

class GlucoseServiceParser {
    ...
    constructor(paths) {
        ...
        this.parseTransaction = (oTransaction) => {
            this.logger.logObject(oTransaction, 'start', 'parseTransaction', 'GlucoseServiceParser');
            let oParsed;
            try {
                oParsed = {
            ...
            this.logger.logObject(oParsed, 'end', 'parseTransaction', 'GlucoseServiceParser');
            return oParsed;
        };
        ...
        this.error = new GlucoseErrorGenerator("com.etauker.glucose", "utils", "GlucoseServiceParser", this.errorMessages);
        this.lastError = null;
    }
}
;
module.exports = GlucoseServiceParser;

import { GlucoseTransaction, IDataLayerGlucoseTransaction } from '../exports';
...
class GlucosePersistenceWorker {
     ...
     */
    public getTransactions = function(oTransactionFilter: IDataLayerGlucoseTransaction) {
     ...
     */
    public saveTransaction = function(oTransaction: IDataLayerGlucoseTransaction) {
     ...
     */
    private _formSelectQuery = function(sTable, oEntity, sOrderClause = '') {

...
class SecurityPersistenceManager {
    constructor(oParams) {
        // Objects
        this.error = new SecurityErrorGenerator('com.etauker.security', 'persistence', 'SecurityPersistenceManager', [
        ...
        this.port = oParams.port || process.env.COM_ETAUKER_SECURITY_DB_PORT || 3306;

...
class SecurityPasswordManager {
    constructor(oPersistenceManager) {
        ...
        this.error = new SecurityErrorGenerator("com.etauker.security", "utils", "SecurityPasswordManager", this.errorMessages);
    }
}
;
